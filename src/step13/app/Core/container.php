...
return function () {
    ...
    Container::getInstance()->set(
        ...
        function ($c) {
            return new \App\Repositories\ArticleCategoryMariadbRepository();
        }
    );
    Container::getInstance()->set(
        'ArticleRepository',
        function ($c) {
            return new \App\Repositories\ArticleMariadbRepository();
        }
    );
    Container::getInstance()->set(
        'ArticleCommentRepository',
        function ($c) {
            return new \App\Repositories\ArticleCommentMariadbRepository();
        }
    );
    Container::getInstance()->set(
        'UserRepository',
    ...
    Container::getInstance()->set(
        'ArticleQueryService',
        function ($c) {
            return new \App\QueryServices\ArticleMariadbQueryService();
        }
    );
};